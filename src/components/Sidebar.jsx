...
import { MdOutlineCancel, OutLineCancel } from "react-icons/md";
...
const Sidebar = () => {
  ...
  const normalLink = `flex items-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-white text-md text-gray-700 dark:text-gray-200 
